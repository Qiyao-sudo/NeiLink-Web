...
const en: Translations = {
    ...
    versions: [
      {
        ...
        label: "Latest",
        date: "2026-05",
        description: "Copy link, tray minimize, close behavior options, and CI/CD build pipeline improvements",
        features: [
          "Click-to-copy link sharing with optimized text interaction",
          "System tray minimize and close behavior customization",
          "Enhanced About page with author info and Markdown rendering",
          "Automated build artifact packaging and version injection in CI/CD",
        ],
      },
      {
        version: "v1.4.0",
        label: "",
        date: "2026-04",
        description: "About page, receiver i18n, statistics dashboard, resumable downloads, and speed limiting",
        features: [
          "About page with built-in version update checker",
          "Receiver page language detection and i18n support",
          "Statistics dashboard with enhanced download logging",
          "HTTP Range request support for resumable downloads and speed limiting",
        ],
      },
      {
        version: "v1.3.0",
        label: "",
        date: "2026-04",
        description: "Theme switching, multilingual support, streaming file transfer, and drag-and-drop input",
        features: [
          "Theme switching with light, dark, and auto modes",
          "Multi-language support for global accessibility",
          "Streaming file transfer for improved large file efficiency",
          "Drag-and-drop file path input and user avatar customization",
        ],
      },
      {
        version: "v1.2.0",
        label: "",
        date: "2026-04",
        description: "Share management overhaul, settings auto-save, and critical bug fixes",
        features: [
          "Support for re-activating expired or canceled share tasks",
          "Unsaved changes detection with auto-save in Settings page",
          "Fixed download progress bar stuck at 0% for encrypted files",
          "Fixed folder sharing failure and file recovery after restart",
        ],
      },
      {
        version: "v1.1.1",
        label: "",
        date: "2026-04",
        description: "Network adapter selection, frameless window, platform packaging, and stability fixes",
        features: [
          "Network adapter selection for flexible connectivity",
          "Frameless window with custom window state management",
          "Platform-specific packaging scripts and build configuration",
          "Multiple bug fixes: IP ban recovery, share cancellation, and logging",
        ],
      },
    ],
  ...
  download: {
    ...
    platforms: [
      { name: "Windows", version: "v1.4.1", size: "93 MB", ext: ".exe", btn: "Download .exe" },
      { name: "macOS", version: "v1.4.1", size: "122 MB", ext: ".dmg", btn: "Download .dmg" },
      { name: "Linux", version: "v1.4.1", size: "77 MB", ext: ".AppImage", btn: "Download .AppImage" },
    ],
